...
const char *gengetopt_args_info_purpose = "Map utilities";

const char *gengetopt_args_info_usage = "Usage: maputil [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -w, --getwidth           Get the width of a map",
  "  -h, --getheight          Get the height of a map",
  "  -o, --getobjects         Get the number of objects of a map",
  "  -i, --getinfo            Get map information",
  "  -W, --setwidth=INT       Set the width of a map",
  "  -H, --setheight=INT      Set the height of a map",
  "  -O, --setobjects=STRING  Replace the objects of a map",
  "  -p, --pruneobjects       Remove unused objects of a map",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->getwidth_given = 0 ;
  args_info->getheight_given = 0 ;
  args_info->getobjects_given = 0 ;
  args_info->getinfo_given = 0 ;
  args_info->setwidth_given = 0 ;
  args_info->setheight_given = 0 ;
  args_info->setobjects_given = 0 ;
  args_info->pruneobjects_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->setwidth_orig = NULL;
  args_info->setheight_orig = NULL;
  args_info->setobjects_arg = NULL;
  args_info->setobjects_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->getwidth_help = gengetopt_args_info_help[3] ;
  args_info->getheight_help = gengetopt_args_info_help[4] ;
  args_info->getobjects_help = gengetopt_args_info_help[5] ;
  args_info->getinfo_help = gengetopt_args_info_help[6] ;
  args_info->setwidth_help = gengetopt_args_info_help[7] ;
  args_info->setheight_help = gengetopt_args_info_help[8] ;
  args_info->setobjects_help = gengetopt_args_info_help[9] ;
  args_info->setobjects_min = 0;
  args_info->setobjects_max = 0;
  args_info->pruneobjects_help = gengetopt_args_info_help[10] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->setwidth_orig));
  free_string_field (&(args_info->setheight_orig));
  free_multiple_string_field (args_info->setobjects_given, &(args_info->setobjects_arg), &(args_info->setobjects_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->getwidth_given)
    write_into_file(outfile, "getwidth", 0, 0 );
  if (args_info->getheight_given)
    write_into_file(outfile, "getheight", 0, 0 );
  if (args_info->getobjects_given)
    write_into_file(outfile, "getobjects", 0, 0 );
  if (args_info->getinfo_given)
    write_into_file(outfile, "getinfo", 0, 0 );
  if (args_info->setwidth_given)
    write_into_file(outfile, "setwidth", args_info->setwidth_orig, 0);
  if (args_info->setheight_given)
    write_into_file(outfile, "setheight", args_info->setheight_orig, 0);
  write_multiple_into_file(outfile, args_info->setobjects_given, "setobjects", args_info->setobjects_orig, 0);
  if (args_info->pruneobjects_given)
    write_into_file(outfile, "pruneobjects", 0, 0 );
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->setobjects_given, args_info->setobjects_min, args_info->setobjects_max, "'--setobjects' ('-O')"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * setobjects_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "Vf:whoiW:H:O:p", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'f':	/* Map file.  */
          ...
          break;
        case 'w':	/* Get the width of a map.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->getwidth_given),
              &(local_args_info.getwidth_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "getwidth", 'w',
              additional_error))
            goto failure;
          ...
          break;
        case 'h':	/* Get the height of a map.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->getheight_given),
              &(local_args_info.getheight_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "getheight", 'h',
              additional_error))
            goto failure;
          ...
          break;
        case 'o':	/* Get the number of objects of a map.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->getobjects_given),
              &(local_args_info.getobjects_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "getobjects", 'o',
              additional_error))
            goto failure;
          ...
          break;
        case 'i':	/* Get map information.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->getinfo_given),
              &(local_args_info.getinfo_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "getinfo", 'i',
              additional_error))
            goto failure;
          ...
          break;
        case 'W':	/* Set the width of a map.  */
        
        
          if (update_arg( (void *)&(args_info->setwidth_arg), 
               &(args_info->setwidth_orig), &(args_info->setwidth_given),
              &(local_args_info.setwidth_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "setwidth", 'W',
              additional_error))
            goto failure;
          ...
          break;
        case 'H':	/* Set the height of a map.  */
        
        
          if (update_arg( (void *)&(args_info->setheight_arg), 
               &(args_info->setheight_orig), &(args_info->setheight_given),
              &(local_args_info.setheight_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "setheight", 'H',
              additional_error))
            goto failure;
          ...
          break;
        case 'O':	/* Replace the objects of a map.  */
        
          if (update_multiple_arg_temp(&setobjects_list, 
              &(local_args_info.setobjects_given), optarg, 0, 0, ARG_STRING,
              "setobjects", 'O',
              additional_error))
            goto failure;
        
          break;
        case 'p':	/* Remove unused objects of a map.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->pruneobjects_given),
              &(local_args_info.pruneobjects_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "pruneobjects", 'p',
              additional_error))
            goto failure;
  ...
  update_multiple_arg((void *)&(args_info->setobjects_arg),
    &(args_info->setobjects_orig), args_info->setobjects_given,
    local_args_info.setobjects_given, 0,
    ARG_STRING, setobjects_list);

  args_info->setobjects_given += local_args_info.setobjects_given;
  local_args_info.setobjects_given = 0;
